...
public class ArrayBag<E> implements Cloneable {
     ...
     * the new elements.
     *
     * @param elements (a variable-arity argument) one or more new elements that
     * are being inserted
     *
     */
    ...
    public E grab() {
        //students' implementation here.
        int random = (int) (Math.random() * manyItems);
        return data[random]; // make sure you change return null to your own return statement.
     ...
     * removed and the method returns true. Otherwise the bag remains unchanged
    ...
    public boolean remove(E target) {
        ...
        if (target == null) {
            System.out.println(manyItems+"true");
            for (index = 0; index < manyItems; index++){
